...
public class BGs extends Choice {
    ...
    public ArrayList<Option> run(){
        ...
        pick.add(new BackGround("City Watch",//Replace with soldier trait, ideals, bonds, flaws
                new ArrayList<>(Arrays.asList(//Traits
                        new Option ("I'm always polite and respectful."),
                        new Option ("I'm haunted by memories of war. I can't get the images of violence out of my mind."),
                        new Option ("I've lost too many friends, and I'm slow to make new ones."),
                        new Option ("I'm full of inspiring and cautionary tales from my military experience relevant to almost every combat situation."),
                        new Option ("I can stare down a hell hound without flinching."),
                        new Option ("I enjoy being strong and like breaking things."),
                        new Option ("I have a crude sense of humor."),
                        new Option ("I face problems head-on. A simple, direct solution is the best path to success."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Ideals
                        new Option ("Greater Good. Our lot is to lay down our lives in defense of others. (Good)"),
                        new Option ("Responsibility. I do what I must and obey just authority. (Lawful)"),
                        new Option ("Independence. When people follow orders blindly, they embrace a kind of tyranny. (Chaotic)"),
                        new Option ("Might. In life as in war, the stronger force wins. (Evil)"),
                        new Option ("Live and Let Live. Ideals aren't worth killing over or going to war for. (Neutral)"),
                        new Option ("Nation. My city, nation, or people are all that matter. (Any)"),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Bonds
                        new Option ("I would still lay down my life for the people I served with."),
                        new Option ("Someone saved my life on the battlefield. To this day, I will never leave a friend behind."),
                        new Option ("My honor is my life."),
                        new Option ("I'll never forget the crushing defeat my company suffered or the enemies who dealt it."),
                        new Option ("Those who fight beside me are those worth dying for."),
                        new Option ("I fight for those who cannot fight for themselves."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Flaws
                        new Option ("The monstrous enemy we faced in battle still leaves me quivering with fear."),
                        new Option ("I have little respect for anyone who is not a proven warrior."),
                        new Option ("I made a terrible mistake in battle that cost many lives – and I would do anything to keep that mistake secret."),
                        new Option ("My hatred of my enemies is blind and unreasoning."),
                        new Option ("I obey the law, even if the law causes misery."),
                        new Option ("I'd rather eat my armor than admit when I'm wrong."),
                        new Option ("Other.")))));
        ...
        pick.add(new BackGround("Cloistered Scholar", //sage
                new ArrayList<>(Arrays.asList(//Traits
                        new Option ("I use polysyllabic words that convey the impression of great erudition."),
                        new Option ("I've read every book in the world's greatest libraries – or I like to boast that I have."),
                        new Option ("I'm used to helping out those who aren't as smart as I am, and I patiently explain anything and everything to others."),
                        new Option ("There's nothing I like more than a good mystery."),
                        new Option ("I'm willing to listen to every side of an argument before I make my own judgment."),
                        new Option ("I… speak… slowly… when talking… to idiots,… which… almost… everyone… is… compared… to me."),
                        new Option ("I am horribly, horribly awkward in social situations."),
                        new Option ("I'm convinced that people are always trying to steal my secrets.\n"),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Ideals
                        new Option ("Knowledge. The path to power and self-improvement is through knowledge. (Neutral)"),
                        new Option ("Beauty. What is beautiful points us beyond itself toward what is true. (Good)"),
                        new Option ("Logic. Emotions must not cloud our logical thinking. (Lawful)"),
                        new Option ("No Limits. Nothing should fetter the infinite possibility inherent in all existence. (Chaotic)"),
                        new Option ("Power. Knowledge is the path to power and domination. (Evil)"),
                        new Option ("Self-Improvement. The goal of a life of study is the betterment of oneself. (Any)"),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Bonds
                        new Option ("It is my duty to protect my students."),
                        new Option ("I have an ancient text that holds terrible secrets that must not fall into the wrong hands."),
                        new Option ("I work to preserve a library, university, scriptorium, or monastery."),
                        new Option ("My life's work is a series of tomes related to a specific field of lore."),
                        new Option ("I've been searching my whole life for the answer to a certain question."),
                        new Option (	"I sold my soul for knowledge. I hope to do great deeds and win it back."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Flaws
                        new Option ("I am easily distracted by the promise of information."),
                        new Option ("Most people scream and run when they see a demon. I stop and take notes on its anatomy."),
                        new Option ("Unlocking an ancient mystery is worth the price of a civilization."),
                        new Option ("I overlook obvious solutions in favor of complicated ones."),
                        new Option ("I speak without really thinking through my words, invariably insulting others."),
                        new Option ("I can't keep a secret to save my life, or anyone else's."),
                        new Option ("Other.")))));
        ...
        pick.add(new BackGround("Sage",
                ...
                new ArrayList<>(Arrays.asList(//Flaws
                        ...
                        new Option ("Other."))),
                new ArrayList<ArrayList<Option>>(Arrays.asList(new ArrayList<Option>(Arrays.asList(
                        new Option ("Alchemist (Specialty)"),
                        new Option ("Astronomer (Specialty)"),
                        new Option ("Discredited academic (Specialty)"),
                        new Option ("Librarian (Specialty)"),
                        new Option ("Professor (Specialty)"),
                        new Option ("Researcher (Specialty)"),
                        new Option ("Wizard's apprentice (Specialty)"),
                        new Option ("Scribe (Specialty)"),
                        new Option ("Other (Specialty)")))))));
        pick.add(new BackGround("Sailor",
                new ArrayList<>(Arrays.asList(//Traits
                        new Option ("My friends know they can rely on me, no matter what."),
                        new Option ("I work hard so that I can play hard when the work is done."),
                        new Option ("I enjoy sailing into new ports and making new friends over a flagon of ale."),
                        new Option ("I stretch the truth for the sake of a good story."),
                        new Option ("To me, a tavern brawl is a nice way to get to know a new city."),
                        new Option ("I never pass up a friendly wager."),
                        new Option ("My language is as foul as an otyugh nest."),
                        new Option ("I like a job well done, especially if I can convince someone else to do it."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Ideals
                        new Option ("Respect. The thing that keeps a ship together is mutual respect between captain and crew. (Good)"),
                        new Option ("Fairness. We all do the work, so we all share in the rewards. (Lawful)"),
                        new Option ("Freedom. The sea is freedom-the freedom to go anywhere and do anything. (Chaotic)"),
                        new Option ("Mastery. I'm a predator, and the other ships on the sea are my prey. (Evil)"),
                        new Option ("People. I'm committed to my crewmates, not to ideals. (Neutral)"),
                        new Option ("Aspiration. Someday I'll own my own ship and chart my own destiny. (Any)"),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Bonds
                        new Option ("I'm loyal to my captain first, everything else second."),
                        new Option ("The ship is most important – crewmates and captains come and go."),
                        new Option ("I'll always remember my first ship."),
                        new Option ("In a harbor town, I have a paramour whose eyes nearly stole me from the sea."),
                        new Option ("I was cheated out of my fair share of the profits, and I want to get my due."),
                        new Option ("Ruthless pirates murdered my captain and crewmates, plundered our ship, and left me to die. Vengeance will be mine"),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Flaws
                        new Option ("I follow orders, even if I think they're wrong."),
                        new Option ("I'll say anything to avoid having to do extra work."),
                        new Option ("Once someone questions my courage, I never back down no matter how dangerous the situation."),
                        new Option ("Once I start drinking, it's hard for me to stop."),
                        new Option ("I can't help but pocket loose coins and other trinkets I come across."),
                        new Option ("My pride will probably lead to my destruction."),
                        new Option ("Other."))),
                new ArrayList<ArrayList<Option>>(Arrays.asList(new ArrayList<Option>(Arrays.asList(
                        new Option ("Bad Reputation (Variant Rule)"),
                        new Option ("Ship's Passage (Non-Variant Rule)")))))));
        pick.add(new BackGround("Shipwright",
                new ArrayList<>(Arrays.asList(//Traits
                        new Option ("I love talking and being heard more than I like to listen."),
                        new Option ("I'm extremely fond of puzzles."),
                        new Option ("I thrive under pressure."),
                        new Option ("I love sketching and designing objects, especially boats."),
                        new Option ("I'm not afraid of hard work—in fact, I prefer it."),
                        new Option ("A pipe, an ale, and the smell of the sea: paradise."),
                        new Option ("I have an endless supply of cautionary tales related to the sea."),
                        new Option ("I don't mind getting my hands dirty."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Ideals
                        new Option ("Crew. If everyone on deck pitches in, we'll never sink. (Good)"),
                        new Option ("Careful Lines. A ship must be balanced according to the laws of the universe. (Lawful)"),
                        new Option ("Invention. Make what you need out of whatever is at hand. (Chaotic)"),
                        new Option ("Perfection. To measure a being and find it lacking is the greatest disappointment. (Evil)"),
                        new Option ("Reflection. Muddied water always clears in time. (Any)"),
                        new Option ("Hope. The horizon at sea holds the greatest promise. (Any)"),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Bonds
                        new Option ("I must visit all the oceans of the world and behold the ships that sail there."),
                        new Option ("Much of the treasure I claim will be used to enrich my community."),
                        new Option ("I must find a kind of wood rumored to possess magical qualities."),
                        new Option ("I repair broken things to redeem what's broken in myself."),
                        new Option ("I will craft a boat capable of sailing through the most dangerous of storms."),
                        new Option ("A kraken destroyed my masterpiece; its teeth shall adorn my hearth."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Flaws
                        new Option ("I don't know when to throw something away. You never know when it might be useful again."),
                        new Option ("I get frustrated to the point of distraction by shoddy craftsmanship."),
                        new Option ("Though I am an excellent crafter, my work tends to look as though it belongs on a ship."),
                        new Option ("I am so obsessed with sketching my ideas for elaborate inventions that I sometimes forget little thing like eating and sleeping."),
                        new Option ("I'm judgmental of those who are not skilled with tools of some kind."),
                        new Option ("I sometimes take things that don't belong to me, especially if they are very well made."),
                        new Option ("Other."))),
                new ArrayList<ArrayList<Option>>(Arrays.asList(new ArrayList<Option>(Arrays.asList(
                        new Option ("Grand Designs. You are working on plans and schematics for a new, very fast ship. You must examine as many different kinds of vessels as possible to help ensure the success of your design. (Seas Influence)"),
                        new Option ("Solid and Sound. You patched up a war galley and prevented it from sinking. The local navy regards you as a friend. (Seas Influence)"),
                        new Option ("Favored. You insisted on thicker planking for a merchant vessel's hull, which saved it from sinking when it smashed against a reef. You have a standing invitation to visit the merchant's distant mansion. (Seas Influence)"),
                        new Option ("Master of Armaments. You specialized in designing and mounting defenses for the navy. You easily recognize and determine the quality of such items. (Seas Influence)"),
                        new Option ("Low Places. You have contacts in the smuggling outfits along the coast; you occasionally repair the criminals' ships in exchange for coin and favors. (Seas Influence)"),
                        new Option ("Mysteries of the Deep. You experienced an encounter with a possibly divine being while sailing alone. Work with your DM to determine the secret about the deep waters of the sea that this entity revealed to you. (Seas Influence)"),
                        new Option ("Other (Seas Influence)")))))));
        pick.add(new BackGround("Smuggler",
                new ArrayList<>(Arrays.asList(//Traits
                        new Option ("I love being on the water but hate fishing."),
                        new Option ("I think of everything in terms of monetary value."),
                        new Option ("I never stop smiling."),
                        new Option ("Nothing rattles me; I have a lie for every occasion."),
                        new Option ("I love gold but won't cheat a friend."),
                        new Option ("I enjoy doing things others believe to be impossible."),
                        new Option ("I become wistful when I see the sun rise over the ocean."),
                        new Option ("I am no common criminal; I am a mastermind."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Ideals
                        new Option ("Wealth: Heaps of coins in a secure vault is all I dream of. (Any)"),
                        new Option ("Smuggler's Code: I uphold the unwritten rules of the smugglers, who do not cheat one another or directly harm innocents. (Lawful)"),
                        new Option ("All for a Coin: I'll do nearly anything if it means I turn a profit. (Evil)"),
                        new Option ("Peace and Prosperity: I smuggle only to achieve a greater goal that benefits my community. (Good)"),
                        new Option ("People: For all my many lies, I place a high value on friendship. (Any)"),
                        new Option ("Daring: I am most happy when risking everything. (Any)"),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Bonds
                        new Option ("My vessel was stolen from me, and I burn with the desire to recover it."),
                        new Option ("I intend to become the leader of the network of smugglers that I belong to."),
                        new Option ("I owe a debt that cannot be repaid in gold."),
                        new Option ("After one last job, I will retire from the business."),
                        new Option ("I was tricked by a fellow smuggler who stole something precious from me. I will find that thief."),
                        new Option ("I give most of my profits to a charitable cause, and I don't like to brag about it."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Flaws
                        new Option ("Lying is reflexive, and I sometimes engage in it without realizing."),
                        new Option ("I tend to assess my relationships in terms of profit and loss."),
                        new Option ("I believe everyone has a price and am cynical toward those who present themselves as virtuous."),
                        new Option ("I struggle to trust the words of others."),
                        new Option ("Few people know the real me."),
                        new Option ("Though I act charming, I feel nothing for others and don't know what friendship is."),
                        new Option ("Other."))),
                new ArrayList<ArrayList<Option>>(Arrays.asList(new ArrayList<Option>(Arrays.asList(
                        new Option ("Spirit of the Whale. You smuggled stolen dwarven spirits in the body of a dead whale being pulled behind a fishing boat. When you delivered the goods, the corpse suddenly exploded, sending whale meat and whiskey bottles for half a mile. (Claim to Fame)"),
                        new Option ("Cart and Sword. You drove a cart filled with stolen art through the middle of a battlefield while singing sea shanties to confuse the combatants. (Claim to Fame)"),
                        new Option ("The Recruit. You enlisted in another nation's navy for the purpose of smuggling stolen jewels to a distant port. You attained a minor rank before disappearing from the navy and making your way here. (Claim to Fame)"),
                        new Option ("River of Shadows. Your riverboat accidentally slipped through the veil into the Shadowfell for several hours. While you were there, you sold some stolen dragonborn artifacts before returning to this plane and paddling home. (Claim to Fame)"),
                        new Option ("Gold-Hearted. You agreed to transport a family escaping a war. The baby began to cry at a checkpoint, and you gave the guards all your gold to let you pass. The family never found out about this gesture. (Claim to Fame)"),
                        new Option ("Playing Both Sides. You once smuggled crates of crossbow bolts and bundles of arrows, each destined for an opposing side in a regional war, at the same time. The buyers arrived within moments of each other but did not discover your trickery. (Claim to Fame)"),
        ...
        pick.add(new BackGround("Soldier",
                ...
                new ArrayList<>(Arrays.asList(//Flaws
                        ...
                        new Option ("Other."))),
                new ArrayList<ArrayList<Option>>(Arrays.asList(new ArrayList<Option>(Arrays.asList(
                        new Option ("Officer (Specialty)"),
                        new Option ("Scout (Specialty)"),
                        new Option ("Infantry (Specialty)"),
                        new Option ("Cavalry (Specialty)"),
                        new Option ("Healer (Specialty)"),
                        new Option ("Quartermaster (Specialty)"),
                        new Option ("Standard bearer (Specialty)"),
                        new Option ("Support staff (cook, blacksmith, or the like) (Specialty)"),
                        new Option ("Other (Specialty)")))))));
        ...
        pick.add(new BackGround("Urchin",
                new ArrayList<>(Arrays.asList(//Traits
                        new Option ("I hide scraps of food and trinkets away in my pockets."),
                        new Option ("I ask a lot of questions."),
                        new Option ("I like to squeeze into small places where no one else can get to me."),
                        new Option ("I sleep with my back to a wall or tree, with everything I own wrapped in a bundle in my arms."),
                        new Option ("I eat like a pig and have bad manners."),
                        new Option ("I think anyone who's nice to me is hiding evil intent."),
                        new Option ("I don't like to bathe."),
                        new Option ("I bluntly say what other people are hinting at or hiding."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Ideals
                        new Option ("Respect. All people, rich or poor, deserve respect. (Good)"),
                        new Option ("Community. We have to take care of each other, because no one else is going to do it. (Lawful)"),
                        new Option ("Change. The low are lifted up, and the high and mighty are brought down. Change is the nature of things. (Chaotic)"),
                        new Option ("Retribution. The rich need to be shown what life and death are like in the gutters. (Evil)"),
                        new Option ("People. I help the people who help me-that's what keeps us alive. (Neutral)"),
                        new Option ("Aspiration. I'm going to prove that I'm worthy of a better life. (Any)"),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Bonds
                        new Option ("My town or city is my home, and I'll fight to defend it."),
                        new Option ("I sponsor an orphanage to keep others from enduring what I was forced to endure."),
                        new Option ("I owe my survival to another urchin who taught me to live on the streets."),
                        new Option ("I owe a debt I can never repay to the person who took pity on me."),
                        new Option ("I escaped my life of poverty by robbing an important person, and I'm wanted for it."),
                        new Option ("No one else should have to endure the hardships I've been through."),
                        new Option ("Other."))),
                new ArrayList<>(Arrays.asList(//Flaws
                        new Option ("If I'm outnumbered, I will run away from a fight."),
                        new Option ("Gold seems like a lot of money to me, and I'll do just about anything for more of it."),
                        new Option ("I will never fully trust anyone other than myself."),
                        new Option ("I'd rather kill someone in their sleep then fight fair."),
                        new Option ("It's not stealing if I need it more than someone else."),
                        new Option ("People who can't take care of themselves get what they deserve."),
                        new Option ("Other.")))));
